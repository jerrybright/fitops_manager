    ...
    <Fragment>
      ...
      <main className="bg-background-1 dark:bg-background-6">
        ...
        <CTAV1
          ...
          ctaHeading="Run your gym smoothly with one powerful management platform."
          description="Manage members, attendance, payments, and expenses from one simple dashboard designed for fitness businesses."
