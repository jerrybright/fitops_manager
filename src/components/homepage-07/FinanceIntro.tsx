      ...
      <div className="main-container flex flex-col-reverse lg:flex-row items-center gap-y-10 lg:gap-24">
        ...
        <div className="md:flex-1 flex flex-col items-center md:items-start lg:items-start lg:text-left">
          <RevealAnimation delay={0.1}>
            <h2 className="mb-3">Take complete control of your gym operations</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.2}>
            <p className="mb-6">
              Operate your gym efficiently with tools that automate daily tasks. From membership plans and attendance tracking to financial records and reports, FitOps Manager helps you run your fitness center smoothly.
            </p>
          </RevealAnimation>
