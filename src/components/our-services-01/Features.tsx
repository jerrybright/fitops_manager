            ...
            <div className="text-center lg:text-left">
              ...
              <RevealAnimation delay={0.2}>
                <h2 className="mb-8 max-w-[520px] mx-auto lg:mx-0">
                  Run and grow your gym from one dashboard.
                </h2>
              </RevealAnimation>
              ...
              <ul className="space-y-4 mb-14">
                ...
                <RevealAnimation delay={0.3}>
                  <li className="flex items-center lg:justify-start justify-center gap-2">
                    <span className="text-secondary/40 dark:text-accent/60">
                      Track member attendance and activity automatically.
                    </span>
                  </li>
                </RevealAnimation>
                ...
                <RevealAnimation delay={0.4}>
                  <li className="flex items-center lg:justify-start justify-center gap-2">
                    <span className="text-secondary/40 dark:text-accent/60">
                      Manage memberships, renewals, and subscription plans easily.
                    </span>
                  </li>
                </RevealAnimation>
                ...
                <RevealAnimation delay={0.5}>
                  <li className="flex items-center lg:justify-start justify-center gap-2">
                    <span className="text-secondary/40 dark:text-accent/60">
                      Monitor income, expenses, and business performance in real time.
                    </span>
                  </li>
                </RevealAnimation>
            ...
            <div className="w-full max-w-max mx-auto lg:mx-0 lg:w-1/2">
              <div className="rounded-[20px] bg-background-3 dark:bg-background-5 p-5 lg:p-8 relative overflow-hidden">
                ...
                <div className="flex gap-4 sm:gap-2.5 flex-wrap sm:flex-nowrap">
                  ...
                  <div className="bg-white dark:bg-background-8 p-6 rounded-2xl w-full sm:w-[55%]">
                    <h5 className="mb-4">Member Activity</h5>

                    <div className="flex items-center gap-4 mb-7">
                      <figure className="inline-block size-14 rounded-full ring-4 ring-white overflow-hidden relative">
                        <Image src={avatar7} alt="avatar" className="max-w-full" />
                        <Image src={authorAvatarBg} alt="avatar" className="absolute top-0 left-0 -z-10" />
                      </figure>

                      <div>
                        <h5 className="text-secondary dark:text-accent">Rahul Kumar</h5>
                        <p className="text-secondary/60 dark:text-accent/60">Active Member</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-secondary/60 dark:text-accent/60 text-tagline-2 font-medium">
                        Checked in today
                      </p>
                    </div>
                  </div>
                  ...
                  {/* PERFORMANCE CARD */}
                  <div className="bg-white dark:bg-background-8 p-6 rounded-2xl w-full sm:w-[45%]">
                    <h5 className="mb-4">Gym Performance</h5>

                    <div className="relative w-fit flex items-center justify-center">
                      <figure className="inline-block size-14 rounded-full ring-4 ring-white overflow-hidden absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <Image src={avatar2} alt="avatar" className="max-w-full" />
                      </figure>
                    </div>
                  </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-start gap-5 p-6 rounded-2xl bg-secondary dark:bg-background-6 max-w-[370px] mt-2.5 z-10 relative">
                  <div className="flex -space-x-3.5 cursor-pointer">
                    <Image className="inline-block size-14 rounded-full ring-4 ring-ns-yellow" src={avatar1} alt="Avatar 1"/>
                    <Image className="inline-block size-14 rounded-full ring-4 ring-ns-yellow" src={avatar2} alt="Avatar 2"/>
                    <Image className="inline-block size-14 rounded-full ring-4 ring-ns-yellow" src={avatar3} alt="Avatar 3"/>
                  </div>

                  <div>
                    <h5 className="text-accent mb-1">Gym Owners</h5>
                    <p className="text-accent/60">Using FitOps Manager</p>
                  </div>
                </div>
...
///uncomment the first one to align the componet