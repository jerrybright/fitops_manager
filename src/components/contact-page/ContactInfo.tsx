...
const contactInfoItems = [
  {
    ...
    icon: homeIcon,
    title: 'Our Address',
    content: '19, Amman Sannathi st,Thamaraikulam, Theni, TamilNadu - 625605',
    gradient: gradient22,
  ...
  },
  {
    ...
    icon: mailIcon,
    title: 'Email Us',
    content: 'vijaykarthickbm@gmail.com',
    link: 'vijaykarthickbm@gmail.com',
    gradient: gradient17,
  ...
  },
  {
    ...
    icon: phoneIcon,
    title: 'Call Us',
    content: '+91 8939995138',
    link: 'tel:+918939995138',
    gradient: gradient6,
